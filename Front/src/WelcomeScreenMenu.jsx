    ...
    return (
        <div className="bg-color-standard grow max-w-[50%] w-6/12">
          <div className="flex flex-col justify-evenly w-8/12 h-8/12 border ml-[17.5%] mt-[17.5%] rounded-[2%] border-solid border-[black] gap-8 p-8">
            ...
            <p className="font-family:'Lato', sans-serif font-semibold text-sm mx-8 text-black text-justify ">
            ...
            <div className="flex self-center">
              <button type="button" onClick={handleClick}  className="lato-bold bg-logo-primary rounded-4xl w-56 h-16 text-white justify-center">QUERO CONHECER</button>
            </div>
          </div>
        </div>
    )
