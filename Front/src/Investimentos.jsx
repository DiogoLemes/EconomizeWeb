                ...
                <div className="lato-bold flex flex-col text-black">
                    ...
                    <div className="flex flex-row justify-between p-4 w-[90%] gap-10">
                        <div className="border-[#d4d4d4] border-1 border-dashed rounded-md flex flex-col text-start p-2 w-[50%] gap-4 overflow-y-scroll h-180">
                            <span className="font-lato">Metas Ativas:</span>
                            {metasAtivas.length == 0 ? <span className="font-lato">Ainda nenhuma meta criada</span> : 
                            ...
                            metasAtivas.map((meta, index) => {
                                ...
                                switch(meta.tipo){
                                    case 1:
                                        bgMeta = "bg-[#DEDCFF] rounded-xl p-4 font-lato flex flex-col gap-2"
                                        ...
                                        break;
                                    case 2:
                                        bgMeta = "bg-[#D1FAE5] rounded-xl p-4 font-lato flex flex-col gap-2"
                                        ...
                                        break;
                                    case 3:
                                        bgMeta = "bg-[#FFEED9] rounded-xl p-4 font-lato flex flex-col gap-2"
                                        ...
                                        break;
                                    case 4:
                                        bgMeta = "bg-[#FFD0D0] rounded-xl p-4 font-lato flex flex-col gap-2"
                        ...
                        <div className="border-[#d4d4d4] border-1 border-dashed rounded-md flex flex-col text-start p-2 w-[50%] gap-4 overflow-y-scroll h-180">
                            <span className="font-lato">Metas Concluídas:</span>
                            {histMetas.length == 0 ? <span className="font-lato">Nenhuma meta concluída</span> : 
                            ...
                            histMetas.map((meta, index) => {
                                ...
                                switch(meta.tipo){
                                    case 1:
                                        bgMeta = "bg-[#DEDCFF] rounded-xl p-4 font-lato flex flex-col gap-2 opacity-50"
                                        tipoMeta = "bg-[#C9C6FF] text-[#3A00E3] rounded-md p-1"
                                        progressoMeta = "h-3 rounded-full bg-[#C9C6FF] [&::-moz-progress-bar]:bg-[#3A00E3]"
                                        textoMeta = "text-[#3A00E3]"
                                        textoTipo = "Poupança"
                                        break;
                                    case 2:
                                        bgMeta = "bg-[#D1FAE5] rounded-xl p-4 font-lato flex flex-col gap-2 opacity-50"
                                        tipoMeta = "bg-[#A7F3D0] text-[#047857] rounded-md p-1"
                                        progressoMeta = "h-3 rounded-full bg-[#A7F3D0] [&::-moz-progress-bar]:bg-[#059669]"
                                        textoMeta = "text-[#047857]"
                                        textoTipo = "Compra"
                                        break;
                                    case 3:
                                        bgMeta = "bg-[#FFEED9] rounded-xl p-4 font-lato flex flex-col gap-2 opacity-50"
                                        tipoMeta = "bg-[#FFD29D] text-[#FF8D00] rounded-md p-1"
                                        progressoMeta = "h-3 rounded-full bg-[#FFD29D] [&::-moz-progress-bar]:bg-[#FFB151]"
                                        textoMeta = "text-[#FF8D00]"
                                        textoTipo = "Viagem"
                                        break;
                                    case 4:
                                        bgMeta = "bg-[#FFD0D0] rounded-xl p-4 font-lato flex flex-col gap-2 opacity-50"
                                        tipoMeta = "bg-[#DB7A7A] text-[#A30000] rounded-md p-1" 
                                        progressoMeta = "h-3 rounded-full bg-[#DB7A7A] [&::-moz-progress-bar]:bg-[#A30000]"
                                        textoMeta = "text-[#A30000]"
                                        textoTipo = "Emergência"
