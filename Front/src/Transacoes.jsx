...
// Importe seu AuthContext real aqui
// import { AuthContext } from './UserContext';
const AuthContext = React.createContext({ id: '1' });

// Mock de componentes - substitua pelos seus componentes reais
...
export default function Transacoes() {
    ...
    // Buscar transações do backend (apenas do mês selecionado)
    useEffect(() => {
    ...
    // Calcular totais (agora os dados já vêm filtrados do backend)
                ...
                <main className="flex-1 p-6 bg-gray-50 overflow-y-auto">
                    ...
                    {error && (
                        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                            <p className="text-red-600 font-medium">❌ Erro ao carregar transações: {error}</p>
                        </div>
                    )}
