              ...
              <div className="flex flex-col">
                ...
                <form className="w-[70%] align-middle mx-[auto] h-[100%]">
                  <div className="flex flex-col p-4 gap-2">
                    ...
                    <button type="submit" onClick={() => submitReceita()} className="bg-[#22DF61] text-black p-2 rounded-xl lato-regular text-xl w-[40%] hover:cursor-pointer">Criar Receita</button>
                  </div>
                </form>
              </div>
            </div>
