...
export default function NovaReceita({onClose}) {
    const botaoInativo = "bg-[#50A96E] p-2 rounded-xl w-50 h-15 hover:cursor-pointer hover:bg-[#22DF61]"
    ...
    return (
      <div>
          <div className="bg-white-div rounded-4xl h-[50%] w-[40%] fixed z-2 top-1/4 left-[30%] p-3 text-black"> {/* tela de categoria */}
            <div className="bg-[#D1FAE5] font-lato-bold text-2xl rounded-3xl w-[100%] h-[100%] flex">
