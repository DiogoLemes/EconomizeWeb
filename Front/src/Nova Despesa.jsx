  ...
  return (
    <div>
        <div className="bg-white-div rounded-4xl h-[50%] w-[40%] fixed z-2 top-1/4 left-[30%] p-3 text-black">
          <div className="bg-despesa-bg font-lato-bold text-2xl rounded-3xl w-[100%] height: 100% flex">
            <div className="flex flex-col">
              <span className="ml-5 mt-5 text-start">Nova Despesa:</span>
              <form className="w-[75%] self-center height: 100%">
                <div className="flex flex-col p-4 gap-2">
                  ...
                  <div className="font-lato-regular text-xl text-start mb-6">
                    ...
                    <div className=" flex width: 100%] justify-items-start gap-4 mt-4">
                  ...
                  <button type="submit" onClick={() => submitDespesa()} className="bg-despesa-button-active text-black p-2 rounded-xl font-lato-regular text-xl w-[60%] hover:cursor-pointer">Criar Despesa</button>
                </div>
              </form>
            </div>
          </div>
