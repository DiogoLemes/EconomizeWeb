...
export default function NovaDespesa({onClose}) {
  ...
  const botaoInativo = "bg-[#DB7A7A] p-2 rounded-xl w-30 hover:cursor-pointer hover:bg-[#FF4D4D]"
  ...
  return (
    <div>
        <div className="bg-white-div rounded-4xl h-[50%] w-[40%] fixed z-2 top-1/4 left-[30%] p-3 text-black"> {/* tela de categoria */}
          <div className="bg-[#FFD0D0] font-lato-bold text-2xl rounded-3xl w-[100%] h-[100%] flex">
            <div className="flex flex-col">
              ...
              <form className="w-[60%] align-middle ml-[15%] h-[100%]">
                <div className="flex flex-col p-4 gap-2">
                  ...
                  className="bg-white rounded-md border-2 border-[#B3B3B3] text-[1.2rem] h-8 font-lato-regular outline-none my-4 p-1"/>  {/* listar menu dropdown das categorias já cadastradas pelo usuário */}
                  ...
                  <button type="submit" onClick={() => submitDespesa()} className="bg-[#FF3C3C] text-black p-2 rounded-xl font-lato-regular text-xl w-[60%] hover:cursor-pointer">Criar Despesa</button>
                </div>
              </form>
            </div>
          </div>
